...
void CobaltQueueDisc::InitializeParams(void)
{
  // Cobalt parameters
  NS_LOG_FUNCTION(this);
...
Time CobaltQueueDisc::GetTarget(void)
{
  return m_target;
}

Time CobaltQueueDisc::GetInterval(void)
{
  return m_interval;
}
...
void CobaltQueueDisc::NewtonStep(void)
{
  NS_LOG_FUNCTION(this);
...
void CobaltQueueDisc::CacheInit(void)
{
  m_recInvSqrt = ~0U;
...
void CobaltQueueDisc::InvSqrt(void)
{
...
void CobaltQueueDisc::DoDispose(void)
{
  NS_LOG_FUNCTION(this);
  m_uv = 0;
  QueueDisc::DoDispose();
...
bool CobaltQueueDisc::CheckConfig(void)
{
  NS_LOG_FUNCTION(this);
