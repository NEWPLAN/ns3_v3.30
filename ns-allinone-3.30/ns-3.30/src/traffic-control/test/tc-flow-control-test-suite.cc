...
void QueueDiscTestItem::AddHeader(void)
{
}

bool QueueDiscTestItem::Mark(void)
{
  return false;
}
...
void TcFlowControlTestCase::CheckPacketsInDeviceQueue(Ptr<NetDevice> dev, uint16_t nPackets, const char *msg)
{
  PointerValue ptr;
...
void TcFlowControlTestCase::CheckDeviceQueueStopped(Ptr<NetDevice> dev, bool value, const char *msg)
{
...
void TcFlowControlTestCase::CheckPacketsInQueueDisc(Ptr<NetDevice> dev, uint16_t nPackets, const char *msg)
{
