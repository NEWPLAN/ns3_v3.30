...
void CobaltQueueDiscBasicEnqueueDequeue::DoRun(void)
{
...
void CobaltQueueDiscDropTest::EnqueueWithDelay(Ptr<CobaltQueueDisc> queue, uint32_t size, uint32_t nPkt)
{
  Address dest;
...
void CobaltQueueDiscDropTest::Enqueue(Ptr<CobaltQueueDisc> queue, uint32_t size, uint32_t nPkt)
{
  Address dest;
  for (uint32_t i = 0; i < nPkt; i++)
  {
...
void CobaltQueueDiscDropTest::DoRun(void)
{
