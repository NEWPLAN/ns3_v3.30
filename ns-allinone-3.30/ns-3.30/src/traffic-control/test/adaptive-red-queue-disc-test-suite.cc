...
void AredQueueDiscTestItem::AddHeader(void)
{
}

bool AredQueueDiscTestItem::Mark(void)
{
  return false;
}
...
void AredQueueDiscTestCase::Enqueue(Ptr<RedQueueDisc> queue, uint32_t size, uint32_t nPkt)
{
  Address dest;
...
void AredQueueDiscTestCase::EnqueueWithDelay(Ptr<RedQueueDisc> queue, uint32_t size, uint32_t nPkt)
{
  Address dest;
...
void AredQueueDiscTestCase::DoRun(void)
{
