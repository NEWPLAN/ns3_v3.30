...
void RedQueueDiscTestItem::AddHeader(void)
{
}

bool RedQueueDiscTestItem::Mark(void)
{
...
void RedQueueDiscTestCase::RunRedTest(QueueSizeUnit mode)
{
  ...
  Enqueue(queue, pktSize, 300, false);
  st = queue->GetStats();
  drop.test3 = st.GetNDroppedPackets(RedQueueDisc::UNFORCED_DROP) + st.GetNDroppedPackets(RedQueueDisc::FORCED_DROP) + st.GetNDroppedPackets(QueueDisc::INTERNAL_QUEUE_DROP);
  ...
  Enqueue(queue, pktSize, 300, false);
  st = queue->GetStats();
  drop.test4 = st.GetNDroppedPackets(RedQueueDisc::UNFORCED_DROP) + st.GetNDroppedPackets(RedQueueDisc::FORCED_DROP) + st.GetNDroppedPackets(QueueDisc::INTERNAL_QUEUE_DROP);
  ...
  Enqueue(queue, pktSize, 300, false);
  st = queue->GetStats();
  drop.test5 = st.GetNDroppedPackets(RedQueueDisc::UNFORCED_DROP) + st.GetNDroppedPackets(RedQueueDisc::FORCED_DROP) + st.GetNDroppedPackets(QueueDisc::INTERNAL_QUEUE_DROP);
  ...
  Enqueue(queue, pktSize, 300, false);
  st = queue->GetStats();
  drop.test6 = st.GetNDroppedPackets(RedQueueDisc::UNFORCED_DROP) + st.GetNDroppedPackets(RedQueueDisc::FORCED_DROP) + st.GetNDroppedPackets(QueueDisc::INTERNAL_QUEUE_DROP);
  ...
  Enqueue(queue, pktSize, 300, false);
  st = queue->GetStats();
  drop.test7 = st.GetNDroppedPackets(RedQueueDisc::UNFORCED_DROP) + st.GetNDroppedPackets(RedQueueDisc::FORCED_DROP) + st.GetNDroppedPackets(QueueDisc::INTERNAL_QUEUE_DROP);
...
void RedQueueDiscTestCase::Enqueue(Ptr<RedQueueDisc> queue, uint32_t size, uint32_t nPkt, bool ecnCapable)
{
  Address dest;
...
void RedQueueDiscTestCase::DoRun(void)
{
