      ...
      TypeId("ns3::ApplicationPacketProbe")
          ...
          .AddTraceSource("OutputBytes",
                          ...
                          MakeTraceSourceAccessor(
                              &ApplicationPacketProbe::m_outputBytes),
                                            ...
                                            const Address &address)
{
  ...
  Ptr<ApplicationPacketProbe> probe =
      Names::Find<ApplicationPacketProbe>(path);
                                             ...
                                             Ptr<Object> obj)
{
  ...
  NS_LOG_DEBUG("Name of probe (if any) in names database: "
               << Names::FindPath(obj));
