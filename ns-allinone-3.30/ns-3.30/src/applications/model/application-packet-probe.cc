...
void ApplicationPacketProbe::SetValue(Ptr<const Packet> packet, const Address &address)
{
...
void ApplicationPacketProbe::SetValueByPath(std::string path, Ptr<const Packet> packet, const Address &address)
{
...
bool ApplicationPacketProbe::ConnectByObject(std::string traceSource, Ptr<Object> obj)
{
...
void ApplicationPacketProbe::TraceSink(Ptr<const Packet> packet, const Address &address)
{
  NS_LOG_FUNCTION(this << packet << address);
  if (IsEnabled())
  {
