...
void ThreeGppHttpServer::SendCallback(Ptr<Socket> socket, uint32_t availableBufferSize)
{
...
void ThreeGppHttpServerTxBuffer::WriteNewObject(Ptr<Socket> socket,
...
void ThreeGppHttpServerTxBuffer::DepleteBufferSize(Ptr<Socket> socket, uint32_t amount)
{
