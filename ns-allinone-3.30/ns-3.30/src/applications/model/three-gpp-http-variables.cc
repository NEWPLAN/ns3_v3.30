...
void ThreeGppHttpVariables::DoInitialize(void)
{
  NS_LOG_FUNCTION(this);
...
void ThreeGppHttpVariables::UpdateMainObjectMuAndSigma(void)
{
  NS_LOG_FUNCTION(this);
...
void ThreeGppHttpVariables::UpdateEmbeddedObjectMuAndSigma(void)
{
  NS_LOG_FUNCTION(this);
