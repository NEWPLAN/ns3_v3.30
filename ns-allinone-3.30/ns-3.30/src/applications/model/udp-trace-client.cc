...
void UdpTraceClient::DoDispose(void)
{
  NS_LOG_FUNCTION(this);
...
void UdpTraceClient::LoadDefaultTrace(void)
{
  NS_LOG_FUNCTION(this);
  uint32_t prevTime = 0;
...
void UdpTraceClient::StartApplication(void)
{
  NS_LOG_FUNCTION(this);
...
void UdpTraceClient::SetTraceLoop(bool traceLoop)
{
