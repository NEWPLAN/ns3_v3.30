...
public:
  ...
  /**
         ...
         * \param address set the socket address for the traced packet equal to
         * this
         */
  ...
  /**
         ...
         *
         * \param traceSource the name of the attribute TraceSource to connect
         * to \param obj ns3::Object to connect to \return true if the trace
         * source was successfully connected
         */
