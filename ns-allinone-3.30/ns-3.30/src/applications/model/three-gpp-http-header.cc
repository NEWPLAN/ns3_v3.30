...
void ThreeGppHttpHeader::SetContentType(ThreeGppHttpHeader::ContentType_t contentType)
{
...
Time ThreeGppHttpHeader::GetClientTs() const
{
...
Time ThreeGppHttpHeader::GetServerTs() const
{
