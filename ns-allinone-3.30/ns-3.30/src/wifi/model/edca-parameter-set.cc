...
void EdcaParameterSet::SetQosSupported(uint8_t qosSupported)
{
...
void EdcaParameterSet::SetQosInfo(uint8_t qosInfo)
{
  m_qosInfo = qosInfo;
}

void EdcaParameterSet::SetBeAifsn(uint8_t aifsn)
{
  m_acBE |= (aifsn & 0x0f);
}

void EdcaParameterSet::SetBeAci(uint8_t aci)
{
  m_acBE |= (aci & 0x03) << 5;
}
...
void EdcaParameterSet::SetBeTxopLimit(uint16_t txop)
{
  m_acBE |= txop << 16;
}

void EdcaParameterSet::SetBkAifsn(uint8_t aifsn)
{
  m_acBK |= (aifsn & 0x0f);
}

void EdcaParameterSet::SetBkAci(uint8_t aci)
{
  m_acBK |= (aci & 0x03) << 5;
}
...
void EdcaParameterSet::SetBkTxopLimit(uint16_t txop)
{
  m_acBK |= txop << 16;
}

void EdcaParameterSet::SetViAifsn(uint8_t aifsn)
{
  m_acVI |= (aifsn & 0x0f);
}

void EdcaParameterSet::SetViAci(uint8_t aci)
{
  m_acVI |= (aci & 0x03) << 5;
}
...
void EdcaParameterSet::SetViTxopLimit(uint16_t txop)
{
  m_acVI |= txop << 16;
}

void EdcaParameterSet::SetVoAifsn(uint8_t aifsn)
{
  m_acVO |= (aifsn & 0x0f);
}

void EdcaParameterSet::SetVoAci(uint8_t aci)
{
  m_acVO |= (aci & 0x03) << 5;
}
...
void EdcaParameterSet::SetVoTxopLimit(uint16_t txop)
{
  m_acVO |= txop << 16;
}
