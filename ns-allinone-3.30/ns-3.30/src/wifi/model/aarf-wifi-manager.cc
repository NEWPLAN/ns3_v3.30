...
void AarfWifiManager::DoReportRxOk(WifiRemoteStation *station,
                                   double rxSnr, WifiMode txMode)
{
  NS_LOG_FUNCTION(this << station << rxSnr << txMode);
}

void AarfWifiManager::DoReportRtsOk(WifiRemoteStation *station,
...
void AarfWifiManager::DoReportDataOk(WifiRemoteStation *st,
...
bool AarfWifiManager::IsLowLatency(void) const
{
  return true;
}
