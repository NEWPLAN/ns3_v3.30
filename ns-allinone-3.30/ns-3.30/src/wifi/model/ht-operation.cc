...
void HtOperation::SetHtSupported(uint8_t htsupported)
{
...
void HtOperation::SetPrimaryChannel(uint8_t ctrl)
{
...
void HtOperation::SetRifsMode(uint8_t rifsmode)
{
  m_rifsMode = rifsmode;
}
...
void HtOperation::SetLSigTxopProtectionFullSupport(uint8_t lsigtxopprotectionfullsupport)
{
  m_lSigTxopProtectionFullSupport = lsigtxopprotectionfullsupport;
}

void HtOperation::SetPcoActive(uint8_t pcoactive)
{
  m_pcoActive = pcoactive;
}

void HtOperation::SetPhase(uint8_t pcophase)
{
  m_pcoPhase = pcophase;
}

void HtOperation::SetRxMcsBitmask(uint8_t index)
{
