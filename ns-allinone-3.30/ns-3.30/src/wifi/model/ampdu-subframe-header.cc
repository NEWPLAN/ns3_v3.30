...
void AmpduSubframeHeader::SetLength(uint16_t length)
{
  m_length = length;
}

void AmpduSubframeHeader::SetEof(bool eof)
{
  m_eof = eof;
}
...
bool AmpduSubframeHeader::GetEof(void) const
{
  return m_eof;
}

bool AmpduSubframeHeader::IsSignatureValid(void) const
{
