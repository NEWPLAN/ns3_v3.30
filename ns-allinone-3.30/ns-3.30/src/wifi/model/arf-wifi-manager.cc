...
void ArfWifiManager::DoReportRxOk(WifiRemoteStation *station,
                                    ...
                                    double ackSnr, WifiMode ackMode, double dataSnr)
{
  ...
  if ((station->m_success == m_successThreshold || station->m_timer == m_timerThreshold) && (station->m_rate < (station->m_state->m_operationalRateSet.size() - 1)))
  {
...
bool ArfWifiManager::IsLowLatency(void) const
{
  return true;
}
