...
void MpduAggregator::SetEdcaQueues(EdcaQueues edcaQueues)
{
  m_edca = edcaQueues;
}

void MpduAggregator::Aggregate(Ptr<const WifiMacQueueItem> mpdu, Ptr<Packet> ampdu, bool isSingle)
{
...
void MpduAggregator::AddHeaderAndPad(Ptr<Packet> mpdu, bool last, bool isSingleMpdu)
{
