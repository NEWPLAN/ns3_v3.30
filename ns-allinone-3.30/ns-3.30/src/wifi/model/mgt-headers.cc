...
void MgtAssocResponseHeader::SetAssociationId(uint16_t aid)
{
  m_aid = aid;
}
...
void MgtProbeRequestHeader::SetExtendedCapabilities(ExtendedCapabilities extendedcapabilities)
{
...
void MgtProbeRequestHeader::SetVhtCapabilities(VhtCapabilities vhtcapabilities)
{
...
void MgtProbeRequestHeader::SetHeCapabilities(HeCapabilities hecapabilities)
{
...
void MgtProbeResponseHeader::SetCapabilities(CapabilityInformation capabilities)
{
...
void MgtProbeResponseHeader::SetExtendedCapabilities(ExtendedCapabilities extendedcapabilities)
{
  m_extendedCapability = extendedcapabilities;
}
...
void MgtProbeResponseHeader::SetHtOperation(HtOperation htoperation)
{
...
void MgtProbeResponseHeader::SetVhtCapabilities(VhtCapabilities vhtcapabilities)
{
  m_vhtCapability = vhtcapabilities;
}
...
void MgtProbeResponseHeader::SetVhtOperation(VhtOperation vhtoperation)
{
...
void MgtProbeResponseHeader::SetHeCapabilities(HeCapabilities hecapabilities)
{
  m_heCapability = hecapabilities;
}
...
void MgtProbeResponseHeader::SetHeOperation(HeOperation heoperation)
{
...
void MgtProbeResponseHeader::SetCfParameterSet(CfParameterSet cfparameterset)
{
...
void MgtProbeResponseHeader::SetSsid(Ssid ssid)
{
  m_ssid = ssid;
}
...
void MgtProbeResponseHeader::SetSupportedRates(SupportedRates rates)
{
  m_rates = rates;
}

void MgtProbeResponseHeader::SetDsssParameterSet(DsssParameterSet dsssParameterSet)
{
...
void MgtProbeResponseHeader::SetErpInformation(ErpInformation erpInformation)
{
...
void MgtProbeResponseHeader::SetEdcaParameterSet(EdcaParameterSet edcaparameters)
{
...
void MgtProbeResponseHeader::Print(std::ostream &os) const
{
  os << "ssid=" << m_ssid << ", "
     << "rates=" << m_rates << ", "
...
void MgtProbeResponseHeader::Serialize(Buffer::Iterator start) const
{
  //timestamp
  //beacon interval
...
void MgtAssocRequestHeader::SetSsid(Ssid ssid)
{
  m_ssid = ssid;
}

void MgtAssocRequestHeader::SetSupportedRates(SupportedRates rates)
{
  m_rates = rates;
}
...
void MgtAssocRequestHeader::SetCapabilities(CapabilityInformation capabilities)
{
  m_capability = capabilities;
}
...
void MgtAssocRequestHeader::SetExtendedCapabilities(ExtendedCapabilities extendedcapabilities)
{
  m_extendedCapability = extendedcapabilities;
}
...
void MgtAssocRequestHeader::SetHtCapabilities(HtCapabilities htcapabilities)
{
  m_htCapability = htcapabilities;
}
...
void MgtAssocRequestHeader::SetVhtCapabilities(VhtCapabilities vhtcapabilities)
{
  m_vhtCapability = vhtcapabilities;
}
...
void MgtAssocRequestHeader::SetHeCapabilities(HeCapabilities hecapabilities)
{
  m_heCapability = hecapabilities;
}
...
Ssid MgtAssocRequestHeader::GetSsid(void) const
{
  return m_ssid;
}
...
void MgtAssocRequestHeader::Print(std::ostream &os) const
{
  os << "ssid=" << m_ssid << ", "
     << "rates=" << m_rates << ", "
     << "Extended Capabilities=" << m_extendedCapability << " , "
...
void MgtAssocRequestHeader::Serialize(Buffer::Iterator start) const
{
  Buffer::Iterator i = start;
  i = m_capability.Serialize(i);
...
void MgtReassocRequestHeader::SetSsid(Ssid ssid)
{
  m_ssid = ssid;
}

void MgtReassocRequestHeader::SetSupportedRates(SupportedRates rates)
{
  m_rates = rates;
}
...
void MgtReassocRequestHeader::SetCapabilities(CapabilityInformation capabilities)
{
  m_capability = capabilities;
}
...
void MgtReassocRequestHeader::SetExtendedCapabilities(ExtendedCapabilities extendedcapabilities)
{
  m_extendedCapability = extendedcapabilities;
}
...
void MgtReassocRequestHeader::SetHtCapabilities(HtCapabilities htcapabilities)
{
  m_htCapability = htcapabilities;
}
...
void MgtReassocRequestHeader::SetVhtCapabilities(VhtCapabilities vhtcapabilities)
{
  m_vhtCapability = vhtcapabilities;
}
...
void MgtReassocRequestHeader::SetHeCapabilities(HeCapabilities hecapabilities)
{
  m_heCapability = hecapabilities;
}
...
Ssid MgtReassocRequestHeader::GetSsid(void) const
{
  return m_ssid;
}
...
void MgtReassocRequestHeader::Print(std::ostream &os) const
{
...
void MgtReassocRequestHeader::Serialize(Buffer::Iterator start) const
{
  Buffer::Iterator i = start;
  i = m_capability.Serialize(i);
  i.WriteHtolsbU16(m_listenInterval);
...
void MgtAssocResponseHeader::SetStatusCode(StatusCode code)
{
  m_code = code;
}

void MgtAssocResponseHeader::SetSupportedRates(SupportedRates rates)
{
  m_rates = rates;
}

void MgtAssocResponseHeader::SetCapabilities(CapabilityInformation capabilities)
{
  m_capability = capabilities;
}
...
void MgtAssocResponseHeader::SetExtendedCapabilities(ExtendedCapabilities extendedcapabilities)
{
  m_extendedCapability = extendedcapabilities;
}
...
void MgtAssocResponseHeader::SetHtCapabilities(HtCapabilities htcapabilities)
{
  m_htCapability = htcapabilities;
}
...
void MgtAssocResponseHeader::SetHtOperation(HtOperation htoperation)
{
  m_htOperation = htoperation;
}
...
void MgtAssocResponseHeader::SetVhtCapabilities(VhtCapabilities vhtcapabilities)
{
  m_vhtCapability = vhtcapabilities;
}
...
void MgtAssocResponseHeader::SetVhtOperation(VhtOperation vhtoperation)
{
  m_vhtOperation = vhtoperation;
}
...
void MgtAssocResponseHeader::SetHeCapabilities(HeCapabilities hecapabilities)
{
  m_heCapability = hecapabilities;
}
...
void MgtAssocResponseHeader::SetHeOperation(HeOperation heoperation)
{
  m_heOperation = heoperation;
}
...
void MgtAssocResponseHeader::SetErpInformation(ErpInformation erpInformation)
{
  m_erpInformation = erpInformation;
}
...
void MgtAssocResponseHeader::SetEdcaParameterSet(EdcaParameterSet edcaparameters)
{
  m_edcaParameterSet = edcaparameters;
}
...
void MgtAssocResponseHeader::Print(std::ostream &os) const
{
...
void MgtAssocResponseHeader::Serialize(Buffer::Iterator start) const
{
  Buffer::Iterator i = start;
  i = m_capability.Serialize(i);
...
void MgtAddBaRequestHeader::SetDelayedBlockAck()
{
  m_policy = 0;
}

void MgtAddBaRequestHeader::SetImmediateBlockAck()
{
  m_policy = 1;
}
...
bool MgtAddBaRequestHeader::IsImmediateBlockAck(void) const
{
...
bool MgtAddBaRequestHeader::IsAmsduSupported(void) const
{
...
void MgtAddBaResponseHeader::SetDelayedBlockAck()
{
  m_policy = 0;
}

void MgtAddBaResponseHeader::SetImmediateBlockAck()
{
  m_policy = 1;
}
...
void MgtAddBaResponseHeader::SetStatusCode(StatusCode code)
{
  m_code = code;
}
...
bool MgtAddBaResponseHeader::IsImmediateBlockAck(void) const
{
  return (m_policy == 1) ? true : false;
}
...
bool MgtAddBaResponseHeader::IsAmsduSupported(void) const
{
  return (m_amsduSupport == 1) ? true : false;
}
...
bool MgtDelBaHeader::IsByOriginator(void) const
{
...
void MgtDelBaHeader::SetByOriginator(void)
{
  m_initiator = 1;
}

void MgtDelBaHeader::SetByRecipient(void)
{
  m_initiator = 0;
}
