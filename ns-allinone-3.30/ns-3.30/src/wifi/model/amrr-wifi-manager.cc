...
void AmrrWifiManager::DoReportRxOk(WifiRemoteStation *station,
...
void AmrrWifiManager::DoReportRtsOk(WifiRemoteStation *st,
                                    double ctsSnr, WifiMode ctsMode, double rtsSnr)
{
  NS_LOG_FUNCTION(this << st << ctsSnr << ctsMode << rtsSnr);
}

void AmrrWifiManager::DoReportDataOk(WifiRemoteStation *st,
...
void AmrrWifiManager::UpdateMode(AmrrWifiRemoteStation *station)
{
  ...
  {
    station->m_success++;
    NS_LOG_DEBUG("++ success=" << station->m_success << " successThreshold=" << station->m_successThreshold << " tx_ok=" << station->m_tx_ok << " tx_err=" << station->m_tx_err << " tx_retr=" << station->m_tx_retr << " rate=" << +station->m_txrate << " n-supported-rates=" << +GetNSupported(station));
...
bool AmrrWifiManager::IsLowLatency(void) const
{
  return true;
}
