...
void Ipv4L3Protocol::Insert(Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
...
void Ipv4L3Protocol::Remove(Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
  NS_LOG_FUNCTION(this << protocol << interfaceIndex);
...
void Ipv4L3Protocol::SetRoutingProtocol(Ptr<Ipv4RoutingProtocol> routingProtocol)
{
...
bool Ipv4L3Protocol::IsDestinationAddress(Ipv4Address address, uint32_t iif) const
{
...
void Ipv4L3Protocol::Receive(Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from,
...
void Ipv4L3Protocol::IpMulticastForward(Ptr<Ipv4MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
...
void Ipv4L3Protocol::RouteInputError(Ptr<const Packet> p, const Ipv4Header &ipHeader, Socket::SocketErrno sockErrno)
{
...
void Ipv4L3Protocol::DoFragmentation(Ptr<Packet> packet, const Ipv4Header &ipv4Header, uint32_t outIfaceMtu, std::list<Ipv4PayloadHeaderPair> &listFragments)
{
...
bool Ipv4L3Protocol::ProcessFragment(Ptr<Packet> &packet, Ipv4Header &ipHeader, uint32_t iif)
{
...
void Ipv4L3Protocol::Fragments::AddFragment(Ptr<Packet> fragment, uint16_t fragmentOffset, bool moreFragment)
{
...
void Ipv4L3Protocol::HandleFragmentsTimeout(std::pair<uint64_t, uint32_t> key, Ipv4Header &ipHeader, uint32_t iif)
{
