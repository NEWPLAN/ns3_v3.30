...
void UdpHeader::InitializeChecksum(Address source,
                                   Address destination,
                                   uint8_t protocol)
{
  m_source = source;
...
void UdpHeader::InitializeChecksum(Ipv4Address source,
...
void UdpHeader::InitializeChecksum(Ipv6Address source,
...
void UdpHeader::ForceChecksum(uint16_t checksum)
{
  m_checksum = checksum;
}
