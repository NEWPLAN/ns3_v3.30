...
void Ipv4EndPoint::SetRxCallback(Callback<void, Ptr<Packet>, Ipv4Header, uint16_t, Ptr<Ipv4Interface>> callback)
{
...
void Ipv4EndPoint::ForwardUp(Ptr<Packet> p, const Ipv4Header &header, uint16_t sport,
...
void Ipv4EndPoint::SetRxEnabled(bool enabled)
{
  m_rxEnabled = enabled;
}

bool Ipv4EndPoint::IsRxEnabled()
{
  return m_rxEnabled;
}
