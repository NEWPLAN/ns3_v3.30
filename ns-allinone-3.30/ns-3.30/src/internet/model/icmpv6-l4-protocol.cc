...
void Icmpv6L4Protocol::SetDownTarget(IpL4Protocol::DownTargetCallback callback)
{
  NS_LOG_FUNCTION(this << &callback);
}

void Icmpv6L4Protocol::SetDownTarget6(IpL4Protocol::DownTargetCallback6 callback)
{
  NS_LOG_FUNCTION(this << &callback);
...
Time Icmpv6L4Protocol::GetReachableTime() const
{
...
Time Icmpv6L4Protocol::GetDelayFirstProbe() const
{
