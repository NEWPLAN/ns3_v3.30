...
void TcpPrrRecovery::EnterRecovery(Ptr<TcpSocketState> tcb, uint32_t dupAckCount,
...
void TcpPrrRecovery::DoRecovery(Ptr<TcpSocketState> tcb, uint32_t lastAckedBytes,
