...
void Ipv4AddressGeneratorImpl::Reset(void)
{
  NS_LOG_FUNCTION(this);
...
void Ipv4AddressGeneratorImpl::Init(
...
void Ipv4AddressGeneratorImpl::InitAddress(
    const Ipv4Address addr,
    const Ipv4Mask mask)
{
...
bool Ipv4AddressGeneratorImpl::IsNetworkAllocated(const Ipv4Address address, const Ipv4Mask mask)
{
  ...
  for (i = m_entries.begin(); i != m_entries.end(); ++i)
  {
    ...
    {
      NS_LOG_LOGIC("Ipv4AddressGeneratorImpl::IsNetworkAllocated(): Network already allocated: " << address << " " << low << "-" << high);
      return false;
    }
  }
  return true;
...
void Ipv4AddressGeneratorImpl::TestMode(void)
{
  NS_LOG_FUNCTION(this);
  m_test = true;
}
...
void Ipv4AddressGenerator::Init(
    const Ipv4Address net,
    const Ipv4Mask mask,
    const Ipv4Address addr)
{
...
void Ipv4AddressGenerator::InitAddress(
    const Ipv4Address addr,
    const Ipv4Mask mask)
{
  NS_LOG_FUNCTION_NOARGS();
...
void Ipv4AddressGenerator::Reset(void)
{
  NS_LOG_FUNCTION_NOARGS();
...
bool Ipv4AddressGenerator::IsNetworkAllocated(const Ipv4Address addr, const Ipv4Mask mask)
{
  NS_LOG_FUNCTION_NOARGS();
...
void Ipv4AddressGenerator::TestMode(void)
{
  NS_LOG_FUNCTION_NOARGS();
