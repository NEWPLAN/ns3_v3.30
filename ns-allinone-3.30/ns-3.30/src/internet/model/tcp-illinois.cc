...
void TcpIllinois::CongestionStateSet(Ptr<TcpSocketState> tcb,
...
void TcpIllinois::IncreaseWindow(Ptr<TcpSocketState> tcb, uint32_t segmentsAcked)
{
                            ...
                            const Time &rtt)
{
  ...
  NS_LOG_INFO("Updated baseRtt = " << m_baseRtt << " maxRtt = " << m_maxRtt << " cntRtt = " << m_cntRtt << " sumRtt = " << m_sumRtt);
}
