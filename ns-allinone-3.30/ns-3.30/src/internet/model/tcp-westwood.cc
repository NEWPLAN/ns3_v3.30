...
TcpWestwood::TcpWestwood(void) : TcpNewReno(),
                                 m_currentBW(0),
                                 m_lastSampleBW(0),
                                 m_lastBW(0),
                                 m_ackedSegments(0),
...
TcpWestwood::TcpWestwood(const TcpWestwood &sock) : TcpNewReno(sock),
...
void TcpWestwood::PktsAcked(Ptr<TcpSocketState> tcb, uint32_t packetsAcked,
                            const Time &rtt)
{
...
void TcpWestwood::EstimateBW(const Time &rtt, Ptr<TcpSocketState> tcb)
{
  NS_LOG_FUNCTION(this);
