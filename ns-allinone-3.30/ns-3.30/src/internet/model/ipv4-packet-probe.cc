...
void Ipv4PacketProbe::SetValue(Ptr<const Packet> packet, Ptr<Ipv4> ipv4, uint32_t interface)
{
...
void Ipv4PacketProbe::SetValueByPath(std::string path, Ptr<const Packet> packet, Ptr<Ipv4> ipv4, uint32_t interface)
{
...
bool Ipv4PacketProbe::ConnectByObject(std::string traceSource, Ptr<Object> obj)
{
