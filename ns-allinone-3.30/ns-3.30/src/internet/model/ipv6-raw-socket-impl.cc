...
void Ipv6RawSocketImpl::Ipv6JoinGroup(Ipv6Address address, Socket::Ipv6MulticastFilterMode filterMode, std::vector<Ipv6Address> sourceAddresses)
{
...
bool Ipv6RawSocketImpl::GetAllowBroadcast() const
{
  return true;
}
