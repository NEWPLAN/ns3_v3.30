...
void UdpL4Protocol::SetNode(Ptr<Node> node)
{
  m_node = node;
}
...
int UdpL4Protocol::GetProtocolNumber(void) const
{
  return PROT_NUMBER;
}

void UdpL4Protocol::DoDispose(void)
{
  NS_LOG_FUNCTION_NOARGS();
...
void UdpL4Protocol::Send(Ptr<Packet> packet,
