...
void Ipv4Header::EnableChecksum(void)
{
...
void Ipv4Header::SetMoreFragments(void)
{
  NS_LOG_FUNCTION(this);
  m_flags |= MORE_FRAGMENTS;
}
void Ipv4Header::SetLastFragment(void)
{
  NS_LOG_FUNCTION(this);
  m_flags &= ~MORE_FRAGMENTS;
}
bool Ipv4Header::IsLastFragment(void) const
{
  NS_LOG_FUNCTION(this);
  return !(m_flags & MORE_FRAGMENTS);
}

void Ipv4Header::SetDontFragment(void)
{
  NS_LOG_FUNCTION(this);
  m_flags |= DONT_FRAGMENT;
}
void Ipv4Header::SetMayFragment(void)
{
  NS_LOG_FUNCTION(this);
  m_flags &= ~DONT_FRAGMENT;
}
bool Ipv4Header::IsDontFragment(void) const
{
  NS_LOG_FUNCTION(this);
...
bool Ipv4Header::IsChecksumOk(void) const
{
  NS_LOG_FUNCTION(this);
