...
void Ipv4RawSocketImpl::DoDispose(void)
{
  NS_LOG_FUNCTION(this);
  m_node = 0;
  Socket::DoDispose();
...
int Ipv4RawSocketImpl::Bind(void)
{
  NS_LOG_FUNCTION(this);
  m_src = Ipv4Address::GetAny();
  return 0;
}
int Ipv4RawSocketImpl::Bind6(void)
{
  NS_LOG_FUNCTION(this);
  return (-1);
}
...
int Ipv4RawSocketImpl::Close(void)
{
  NS_LOG_FUNCTION(this);
...
int Ipv4RawSocketImpl::ShutdownSend(void)
{
  NS_LOG_FUNCTION(this);
  m_shutdownSend = true;
  return 0;
}
int Ipv4RawSocketImpl::ShutdownRecv(void)
{
  NS_LOG_FUNCTION(this);
  m_shutdownRecv = true;
  return 0;
...
int Ipv4RawSocketImpl::Listen(void)
{
  NS_LOG_FUNCTION(this);
...
bool Ipv4RawSocketImpl::ForwardUp(Ptr<const Packet> p, Ipv4Header ipHeader, Ptr<Ipv4Interface> incomingInterface)
{
