...
void TcpRxBuffer::SetMaxBufferSize(uint32_t s)
{
  m_maxBuffer = s;
}
...
bool TcpRxBuffer::Finished(void)
{
  return (m_gotFin && m_finSeq < m_nextRxSeq);
}

bool TcpRxBuffer::Add(Ptr<Packet> p, TcpHeader const &tcph)
{
...
void TcpRxBuffer::UpdateSackList(const SequenceNumber32 &head, const SequenceNumber32 &tail)
{
