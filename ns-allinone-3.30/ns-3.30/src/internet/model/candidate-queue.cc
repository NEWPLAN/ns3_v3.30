...
void CandidateQueue::Clear(void)
{
  NS_LOG_FUNCTION(this);
...
bool CandidateQueue::Empty(void) const
{
  NS_LOG_FUNCTION(this);
...
void CandidateQueue::Reorder(void)
{
  NS_LOG_FUNCTION(this);
 ...
 */
bool CandidateQueue::CompareSPFVertex(const SPFVertex *v1, const SPFVertex *v2)
{
  ...
  {
    if (v1->GetVertexType() == SPFVertex::VertexNetwork && v2->GetVertexType() == SPFVertex::VertexRouter)
    {
      result = true;
    }
  }
