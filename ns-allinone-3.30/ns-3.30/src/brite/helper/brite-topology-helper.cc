...
void BriteTopologyHelper::BuildBriteNodeInfoList(void)
{
  NS_LOG_FUNCTION(this);
...
void BriteTopologyHelper::BuildBriteEdgeInfoList(void)
{
  NS_LOG_FUNCTION(this);
  brite::Graph *g = m_topology->GetGraph();
...
void BriteTopologyHelper::BuildBriteTopology(InternetStackHelper &stack, const uint32_t systemCount)
{
  NS_LOG_FUNCTION(this);
