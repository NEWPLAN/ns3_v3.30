...
void BridgeNetDevice::ReceiveFromDevice(Ptr<NetDevice> incomingPort, Ptr<const Packet> packet, uint16_t protocol,
...
void BridgeNetDevice::ForwardUnicast(Ptr<NetDevice> incomingPort, Ptr<const Packet> packet,
...
void BridgeNetDevice::ForwardBroadcast(Ptr<NetDevice> incomingPort, Ptr<const Packet> packet,
                                       uint16_t protocol, Mac48Address src, Mac48Address dst)
{
  NS_LOG_FUNCTION_NOARGS();
  NS_LOG_DEBUG("LearningBridgeForward (incomingPort=" << incomingPort->GetInstanceTypeId().GetName()
...
bool BridgeNetDevice::IsLinkUp(void) const
{
  NS_LOG_FUNCTION_NOARGS();
  return true;
}
...
bool BridgeNetDevice::IsBroadcast(void) const
{
  NS_LOG_FUNCTION_NOARGS();
  return true;
}
...
bool BridgeNetDevice::IsMulticast(void) const
{
  NS_LOG_FUNCTION_NOARGS();
  return true;
}
...
bool BridgeNetDevice::IsPointToPoint(void) const
{
  NS_LOG_FUNCTION_NOARGS();
  return false;
}

bool BridgeNetDevice::IsBridge(void) const
{
  NS_LOG_FUNCTION_NOARGS();
  return true;
}

bool BridgeNetDevice::Send(Ptr<Packet> packet, const Address &dest, uint16_t protocolNumber)
{
  NS_LOG_FUNCTION_NOARGS();
  return SendFrom(packet, m_address, dest, protocolNumber);
}

bool BridgeNetDevice::SendFrom(Ptr<Packet> packet, const Address &src, const Address &dest, uint16_t protocolNumber)
{
  NS_LOG_FUNCTION_NOARGS();
...
bool BridgeNetDevice::NeedsArp(void) const
{
  NS_LOG_FUNCTION_NOARGS();
  return true;
}
...
void BridgeNetDevice::SetPromiscReceiveCallback(NetDevice::PromiscReceiveCallback cb)
{
  NS_LOG_FUNCTION_NOARGS();
