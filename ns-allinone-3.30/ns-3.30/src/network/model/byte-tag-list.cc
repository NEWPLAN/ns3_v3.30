...
bool ByteTagList::Iterator::HasNext(void) const
{
  NS_LOG_FUNCTION(this);
...
void ByteTagList::Iterator::PrepareForNext(void)
{
  NS_LOG_FUNCTION(this);
...
void ByteTagList::RemoveAll(void)
{
  NS_LOG_FUNCTION(this);
  Deallocate(m_data);
  m_minStart = INT32_MAX;
...
void ByteTagList::Deallocate(struct ByteTagListData *data)
{
