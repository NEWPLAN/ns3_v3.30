...
void Buffer::Recycle(struct Buffer::Data *data)
{
...
void Buffer::Deallocate(struct Buffer::Data *data)
{
  NS_LOG_FUNCTION(data);
  NS_ASSERT(data->m_count == 0);
...
bool Buffer::CheckInternalState(void) const
{
  NS_LOG_FUNCTION(this);
#if 0
...
void Buffer::TransformIntoRealBuffer(void) const
{
  NS_LOG_FUNCTION(this);
  NS_ASSERT(CheckInternalState());
...
bool Buffer::Iterator::IsEnd(void) const
{
  NS_LOG_FUNCTION(this);
  return m_current == m_dataEnd;
}
bool Buffer::Iterator::IsStart(void) const
{
  NS_LOG_FUNCTION(this);
...
void Buffer::Iterator::Write(uint8_t const *buffer, uint32_t size)
{
  NS_LOG_FUNCTION(this << &buffer << size);
