...
void Socket::SetConnectCallback(
...
void Socket::SetDataSentCallback(Callback<void, Ptr<Socket>, uint32_t> dataSent)
{
...
void Socket::NotifyConnectionSucceeded(void)
{
  NS_LOG_FUNCTION(this);
...
void Socket::NotifyConnectionFailed(void)
{
  NS_LOG_FUNCTION(this);
...
void Socket::NotifyNormalClose(void)
{
  NS_LOG_FUNCTION(this);
...
void Socket::NotifyErrorClose(void)
{
  NS_LOG_FUNCTION(this);
...
void Socket::NotifyNewConnectionCreated(Ptr<Socket> socket, const Address &from)
{
...
void Socket::NotifyDataRecv(void)
{
  NS_LOG_FUNCTION(this);
...
bool Socket::IsManualIpv6Tclass(void) const
{
  return m_manualIpv6Tclass;
}

bool Socket::IsManualIpTtl(void) const
{
  return m_manualIpTtl;
}

bool Socket::IsManualIpv6HopLimit(void) const
{
...
void Socket::SetIpRecvTos(bool ipv4RecvTos)
{
  m_ipRecvTos = ipv4RecvTos;
}

bool Socket::IsIpRecvTos(void) const
{
  return m_ipRecvTos;
}
...
bool Socket::IsIpv6RecvTclass(void) const
{
...
void Socket::SetIpRecvTtl(bool ipv4RecvTtl)
{
  m_ipRecvTtl = ipv4RecvTtl;
}

bool Socket::IsIpRecvTtl(void) const
{
  return m_ipRecvTtl;
}
...
bool Socket::IsIpv6RecvHopLimit(void) const
{
  return m_ipv6RecvHopLimit;
}

void Socket::Ipv6JoinGroup(Ipv6Address address, Ipv6MulticastFilterMode filterMode, std::vector<Ipv6Address> sourceAddresses)
{
...
void Socket::Ipv6LeaveGroup(void)
{
  NS_LOG_FUNCTION(this);
...
void SocketSetDontFragmentTag::Enable(void)
{
  NS_LOG_FUNCTION(this);
  m_dontFragment = true;
}
void SocketSetDontFragmentTag::Disable(void)
{
  NS_LOG_FUNCTION(this);
  m_dontFragment = false;
}
bool SocketSetDontFragmentTag::IsEnabled(void) const
{
  NS_LOG_FUNCTION(this);
...
void SocketIpTosTag::SetTos(uint8_t ipTos)
{
  m_ipTos = ipTos;
}
...
void SocketIpTosTag::Serialize(TagBuffer i) const
{
  i.WriteU8(m_ipTos);
}

void SocketIpTosTag::Deserialize(TagBuffer i)
{
  m_ipTos = i.ReadU8();
}
...
void SocketPriorityTag::SetPriority(uint8_t priority)
{
  m_priority = priority;
}
...
void SocketPriorityTag::Serialize(TagBuffer i) const
{
  i.WriteU8(m_priority);
}

void SocketPriorityTag::Deserialize(TagBuffer i)
{
  m_priority = i.ReadU8();
}
...
void SocketIpv6TclassTag::SetTclass(uint8_t tclass)
{
  m_ipv6Tclass = tclass;
}
