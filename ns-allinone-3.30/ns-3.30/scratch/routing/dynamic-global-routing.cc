...
{
  LogComponentEnable("DynamicGlobalRoutingExample", LOG_LEVEL_ALL);
  ...
  Ptr<OutputStreamWrapper> stream = ascii.CreateFileStream("scratch/data/dynamic-global-routing.tr");
  ...
  Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper>("scratch/data/dynamic-global-routing.routes", std::ios::out);
